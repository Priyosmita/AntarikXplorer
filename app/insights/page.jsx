...
const BlogList = () => {
  ...
  return (
    <div
      className="min-h-screen bg-cover bg-center bg-[url('/landing-page-assets/insights.mp4')]"
      style={{
        backgroundImage: `url('/landing-page-assets/insights.mp4')`,
      }}
    >
      {/* Header Component */}
      <Header
      ...
      <section className="w-full pt-32 bg-transparent">
        <div
          className="container mx-auto px-4 max-h-[80vh]"
