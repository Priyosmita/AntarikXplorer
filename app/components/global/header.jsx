      ...
      <div className="flex justify-between items-center p-4 mt-4">
        ...
        <div className="flex items-center space-x-4">
          ...
          <div className="flex flex-col">
            <span className="text-white text-md viga-regular tracking-widest font-thin opacity-85">{name}</span>
            <span className="text-white text-xs viga-regular tracking-wider opacity-75">{catchPhrase}</span>
          </div>
        </div>
